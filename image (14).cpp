...
int main(int argc, const char * argv[])
{
	...
	if (imMat.empty() == true) {
		...
		cv::addWeighted(monocolor[0], 0, monocolor[0], 1, -90, monocolor[0]);
		cv::addWeighted(monocolor[1], 0, monocolor[1], 0.75, 0, monocolor[1]);
		cv::addWeighted(monocolor[2], 0, monocolor[2], 1.25, 0, monocolor[2]);
